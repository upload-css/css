...
function __construct(){
 ...
 function kondisi_list()
 {
        ...
        $id_nik = trim($this->session->userdata('user_id'));
        ...
        LEFT JOIN bagian_departemen E ON E.id_bagian_dept = D.id_bagian_dept WHERE status = 1";
        ...
        $sql_tiket_tugas = "SELECT COUNT(A.id_ticket) AS jml_tiket_tugas
                               FROM ticket A 
                               LEFT JOIN sub_kategori B ON B.id_sub_kategori = A.id_sub_kategori
                               LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
                               LEFT JOIN karyawan D ON D.nik = A.reported
                               ...
                               WHERE F.nik = '$id_nik'
                               AND A.status = 3";
        $row_tiket_tugas = $this->db->query($sql_tiket_tugas)->row();

        $data['notif_tiket_tugas'] = $row_tiket_tugas->jml_tiket_tugas;
